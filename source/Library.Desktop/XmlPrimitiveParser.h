...
namespace Library
{
	class XmlPrimitiveParser : public IXmlParseHelper
	{
	public:
		/*!
		...
		*/
		...
		virtual ~XmlPrimitiveParser() = default;
		XmlPrimitiveParser() = default;
		virtual void Initialize() override {}

	private:
		typedef XmlTableParser::SharedData SharedData;
		Datum::DatumType CurrentType;
		static Hashmap<string, Datum::DatumType> primitiveTable;
	};
}