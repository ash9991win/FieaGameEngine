...
namespace Library
{
	...
	private:
		...
		bool EntityActionHandler(SharedData& data,std::string className,std::string InstanceName,std::string Attributename);
		bool ActionListIfHandler(SharedData& data, std::string className, std::string InstanceName,std::string thenelse);
